...
CREATE INDEX idx_quest_sessions_session_id ON quest_sessions(session_id);
CREATE INDEX idx_quest_sessions_status ON quest_sessions(status);
CREATE INDEX idx_quest_sessions_expires_at ON quest_sessions(expires_at);
